...
const MainLeftSection = () => {
    const { userData: { profile, careerObjective, contact, skills, education, interests, languages, hobbies } } = useSelector((state: RootState) => state.resume)
...
const CreativeSpark = () => {
    ...
    return (
        <ResumeContainer
            resumeRef={resumeRef} resClassName='creative-spark'
            isSectioned={true}
