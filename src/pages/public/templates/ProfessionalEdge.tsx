...
const MainRightSection = () => {
    const { userData: { contact, skills, education, hobbies, interests, languages } } = useSelector((state: RootState) => state.resume)
...
const MainLeftSection = () => {
    const { userData: { careerObjective, workExperience, projects, certifications, awardsAndHonors } } = useSelector((state: RootState) => state.resume)
